                ...
                <div>
                    ...
                    <div class="nav__list">
                        ...
                        <a href="{{Route('studentlist')}}" class="nav__link">
                            ...
                            <span class="nav__name">Upcoming Lesson</span>
                        </a>
                        <a href="{{Route('suscribe')}}" class="nav__link">
                            <i class='bx bx-message-square-detail nav__icon' ></i>
                            <span class="nav__name">surcribe</span>
                        </a>

                        <a href="{{Route('unSuscribe')}}" class="nav__link">
                            <i class='bx bx-message-square-detail nav__icon' ></i>
                            <span class="nav__name">UnSurcribe</span>
                        </a>

                        <a href="{{Route("allLesson")}}" class="nav__link">
                            <i class='bx bx-bookmark nav__icon' ></i>
                            <span class="nav__name">All course</span>
                        </a>
                        ...
                        <a href="#" class="nav__link">
                            ...
                            <span class="nav__name">Passed Lesson</span>
                        </a>
                    </div>
                </div>
