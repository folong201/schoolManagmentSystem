...
Route::middleware('teacherMiddleware')->group(function(){
    ...
    Route::get('upcomingLesson',[LessonController::class,'upcomingLesson'])->name('upcomingLesson');
...
Route::middleware('studentMiddleware')->group(function(){
    ...
    Route::get('studentCourseList','LessonController@studentCourseList')->name('studentCourseList');
